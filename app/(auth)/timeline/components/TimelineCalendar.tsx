...
const TimelineCalendar: React.FC<TimelineCalendarProps> = ({ data, onAddEntry }) => {
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="mt-4 flex justify-center">
                <Button variant="outline" size="sm" onClick={handleOpenAddModal} className="w-full">
        ...
        <div className="md:col-span-3">
          <Card className="h-full">
            <CardHeader className="pb-2 flex flex-row items-center justify-between">
              ...
              {selectedDate && (
                <Button variant="outline" size="sm" onClick={handleOpenAddModal} className="h-8">
                  <PlusCircle className="mr-2 h-4 w-4" />
                  Thêm
                </Button>
              )}
                  ...
                  {entriesForSelectedDate.length > 0 ? (
                    <div className="space-y-4">
                      {entriesForSelectedDate.map((entry, index) => {
                        ...
                        return (
                          ...
                          >
                            <Card className="overflow-hidden border-l-4 border-l-lime-500">
                    ...
                    <div className="flex flex-col items-center justify-center py-12 text-center">
                      ...
                      <p className="text-sm text-slate-500 max-w-sm mb-4">
                        Không có hoạt động nào được ghi lại cho ngày này. Bạn có thể thêm hoạt động mới.
                      </p>
                      <Button onClick={handleOpenAddModal} className="bg-lime-600 hover:bg-lime-700">
                        <PlusCircle className="mr-2 h-4 w-4" />
                        Thêm hoạt động mới
                      </Button>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center py-12 text-center">
                      ...
                      <p className="text-sm text-slate-500 max-w-sm">
                        Chọn một ngày từ lịch để xem hoặc thêm hoạt động.
                      </p>
                    </div>
                  )}
                </AnimatePresence>
