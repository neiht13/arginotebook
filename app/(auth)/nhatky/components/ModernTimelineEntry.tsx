...
const ModernTimelineEntry = ({ entry, onEdit, onDelete, isLast }: ModernTimelineEntryProps) => {
    ...
    >
      ...
      <div className="relative z-10 flex gap-4">
        ...
        <div className="flex-grow">
          <motion.div
            layout
            className="bg-white rounded-lg shadow-sm overflow-hidden border border-lime-100 hover:shadow-md transition-shadow"
          >
            {/* Card header */}
